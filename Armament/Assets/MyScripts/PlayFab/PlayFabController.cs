...
public class PlayFabController : MonoBehaviour
{
    ...
    private void OnLoginSuccess(LoginResult result) {
        ...
        Debug.Log("Login Success for User \"" + username + "\". Display Name: " + displayName);
        PlayerPrefs.SetString("EMAIL", userEmail);
        PlayerPrefs.SetString("PASSWORD", userPassword);

        if (username == "beepbeep" || username == "benmankin")
        {
            sharedGroupId = "TEST_FOR_DEMO_GROUP_ID";
        }
    ...
    private void OnLoginMobileSuccess(LoginResult result) {
        Debug.Log("Mobile Login Success for User \"" + username + "\". Display Name: " + displayName);
    ...
    private void OnRegisterSuccess(RegisterPlayFabUserResult result) {
        //Log and set player's Email and Password strings for next time
        Debug.Log("Registration Success for User \"" + username + "\". Display Name: " + displayName);
        PlayerPrefs.SetString("EMAIL", userEmail);
        PlayerPrefs.SetString("PASSWORD", userPassword);


        if (username == "benmankin")
        {
            sharedGroupId = "TEST_FOR_DEMO_GROUP_ID";
        }
